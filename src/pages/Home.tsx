...
const Home: React.FC = () => {
  ...
  const calculatePortfolioValue = () => {
    ...
    return Object.entries(userData.portfolio).reduce(
      (total, [coinId, amount]) => {
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link
              to="/dashboard"
              className="flex items-center justify-between bg-blue-100 p-4 rounded-lg hover:bg-blue-200 transition-colors"
            >
            ...
            <Link
              to="/crypto/bitcoin"
              className="flex items-center justify-between bg-yellow-100 p-4 rounded-lg hover:bg-yellow-200 transition-colors"
            >
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 text-center">
      ...
      <p className="text-xl mb-8">
        Start trading cryptocurrencies with real-time market data
      </p>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p>
            Practice trading with a virtual balance and risk-free environment
          </p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md">
